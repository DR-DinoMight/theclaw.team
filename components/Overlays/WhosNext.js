...
export default function WhosNext({ customTransition = false }) {
  ...
  return (
    <div className={styles.overlay__container}>
      <div className={styles.overlay__whosNext__topLeft}>
        {customTransition && (
          <div className={styles.overlay__whosNext__container}>
            <WhosNextContainer nextUp={nextUp} avatar={avatar} isPartner={isPartner} />
          </div>
        )}
        {!customTransition && (
          <motion.div
...
function WhosNextContainer({ nextUp, avatar, isPartner }) {
